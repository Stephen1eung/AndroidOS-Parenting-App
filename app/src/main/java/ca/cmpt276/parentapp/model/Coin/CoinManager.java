...
public class CoinManager implements  Iterable<Coin>{
    ...
    public ArrayList<Coin> getCoinHistory() {
        if (coinHistoryArrayList == null) coinHistoryArrayList = new ArrayList<>();return coinHistoryArrayList; }
    ...
    @NonNull
    @Override
    public Iterator<Coin> iterator() { return coinHistoryArrayList.iterator(); }
}
